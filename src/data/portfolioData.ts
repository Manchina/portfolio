...
export const PORTFOLIO_DATA = {
  personal: {
    ...
    tagline: 'Building High-Scale Backend Systems, Cloud Infrastructure & Autonomous AI Agents',
    bio: 'Product Engineer specializing in high-throughput event-driven microservices (AWS SNS → Lambda → SQS/SES), ultra-low latency Fastify & Node.js APIs, type-safe database architectures with Drizzle ORM + Aurora PostgreSQL, and self-healing autonomous AI agents.',
    ...
    availability: 'Open for high-impact Product Engineering & Full Stack Roles',
    stats: [
  ...
  projects: [
    ...
    {
      id: 'wysbryx-event-engine',
      title: 'Enterprise Event-Driven Workflow Engine',
      subtitle: 'High-Throughput AWS Event-Driven Microservice (SNS → Lambda → SQS/SES)',
      description: 'High-throughput asynchronous event-processing pipeline powering 150+ critical enterprise workflows across 12 modules with multi-region delivery and sub-10ms data access.',
      ...
      featured: true,
      architectureNotes: 'Decoupled SNS Fan-out -> Dedicated Worker SQS Queues -> Multi-Region Dispatchers + Aurora PostgreSQL',
    },
    {
      id: 'assetops',
      title: 'AssetOps',
  ...
  experience: [
    {
      ...
      type: 'Full-time',
      points: [
        'Owned and scaled an enterprise event-driven microservice supporting 150+ critical workflows across 12 HR modules, constructed using Node.js, TypeScript, Fastify, and AWS.',
        'Re-architected synchronous API flows into an event-driven AWS architecture (SNS → Lambda → SQS/SES), reducing API latency by ~80% and isolating downstream failures.',
        'Designed multi-region event routing across NA, India, and UK, supporting region-specific business rules and dynamic recipient resolution.',
        ...
        'Implemented non-production delivery safeguards, structured Pino/CloudWatch logging, and Vitest unit/integration tests to improve security, observability, and release reliability.',
      ],
